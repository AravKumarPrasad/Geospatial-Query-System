...
ld_list1 = list(set(countries["name"]))

def fuzzy_match_location(user_input, threshold=50):
...
def correct_names(text):
    ...
    for item in first_index:
     ...
     my_list.append(f"{item} ,{latitude}, {longitude}, {category}.")
    return my_list
